...
const buildHomePageElement = (function () {
  ...
  let navList = ["My Project", "Scheduled", "Over Due", "Settings"];
...
const setNavClickHandlers = () => {
  const body = document.querySelector("body");
  buildHomePageElement.getNavBar();
  buildHomePageElement.getContent();
...
export const renderTextToContentDiv = () => {
  ...
  welcomeNote.textContent =
    "We're here to make your life easier. With our TodoApp, we can prioritize your professional life and activities efficiently and simplify your daily tasks";
  titleDiv.appendChild(welcomeNote);

  const buttonDiv = document.createElement("div");
  buttonDiv.className = "buttonDiv";

  const buttons = ["Menu", "Explore"];
